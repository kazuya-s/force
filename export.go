...
func runExport(cmd *Command, args []string) {
	...
	query := ForceMetadataQuery{
		...
		{Name: "ActionLinkGroupTemplate", Members: []string{"*"}},
		...
		{Name: "ApexTestSuite", Members: []string{"*"}},
		{Name: "ApexTrigger", Members: []string{"*"}},
		{Name: "AppMenu", Members: []string{"*"}},
		...
		{Name: "CleanDataService", Members: []string{"*"}},
		{Name: "CompanySettings", Members: []string{"*"}},
		{Name: "Community", Members: []string{"*"}},
		{Name: "CommunityTemplateDefinition", Members: []string{"*"}},
		{Name: "CommunityThemeDefinition", Members: []string{"*"}},
		{Name: "CompactLayout", Members: []string{"*"}},
		{Name: "ConnectedApp", Members: []string{"*"}},
		{Name: "ContentAsset", Members: []string{"*"}},
		{Name: "ContractSettings", Members: []string{"*"}},
		{Name: "CorsWhitelistOrigin", Members: []string{"*"}},
		...
		{Name: "DuplicateRule", Members: []string{"*"}},
		{Name: "EscalationRules", Members: []string{"*"}},
		...
		{Name: "FlexiPage", Members: []string{"*"}},
		{Name: "Flow", Members: []string{"*"}},
		{Name: "Folder", Members: []string{"*"}},
		{Name: "ForecastingSettings", Members: []string{"*"}},
		{Name: "GlobalValueSet", Members: []string{"*"}},
		{Name: "GlobalValueSetTranslation", Members: []string{"*"}},
		...
		{Name: "KeywordList", Members: []string{"*"}},
		...
		{Name: "Settings", Members: []string{"*"}},
		{Name: "SharingReason", Members: []string{"*"}},
		{Name: "SharingRules", Members: []string{"*"}},
		{Name: "SharingSet", Members: []string{"*"}},
		{Name: "Skill", Members: []string{"*"}},
		{Name: "StandardValueSetTranslation", Members: []string{"*"}},
		{Name: "StaticResource", Members: []string{"*"}},
		{Name: "SynonymDictionary", Members: []string{"*"}},
		{Name: "Territory", Members: []string{"*"}},
		{Name: "TransactionSecurityPolicy", Members: []string{"*"}},
